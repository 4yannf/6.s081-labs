...
int main(int argc, char *argv[])
{
  ...
  34:	7d058593          	addi	a1,a1,2000 # 800 <malloc+0xf2>
  38:	4509                	li	a0,2
  3a:	00000097          	auipc	ra,0x0
  3e:	5ee080e7          	jalr	1518(ra) # 628 <fprintf>
    exit(1);
  42:	4505                	li	a0,1
...
putc(int fd, char c)
{
 ...
 392:	f6e080e7          	jalr	-146(ra) # 2fc <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c4:	4b850513          	addi	a0,a0,1208 # 878 <digits>
 3c8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 484:	3a0c8c93          	addi	s9,s9,928 # 820 <malloc+0x112>
 ...
 492:	3eab8b93          	addi	s7,s7,1002 # 878 <digits>
 ...
 5b8:	26498993          	addi	s3,s3,612 # 818 <malloc+0x10a>
        while(*s != 0){
 5bc:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 7e8:	b80080e7          	jalr	-1152(ra) # 364 <sbrk>
  if(p == (char*)-1)
