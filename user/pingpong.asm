...
int main(){
  ...
  62:	86258593          	addi	a1,a1,-1950 # 8c0 <malloc+0xea>
  66:	4505                	li	a0,1
  68:	00000097          	auipc	ra,0x0
  6c:	688080e7          	jalr	1672(ra) # 6f0 <fprintf>
    write(p2[1], "a", 1);
  70:	4605                	li	a2,1
  72:	00001597          	auipc	a1,0x1
  76:	86658593          	addi	a1,a1,-1946 # 8d8 <malloc+0x102>
  ...
  c6:	81658593          	addi	a1,a1,-2026 # 8d8 <malloc+0x102>
  ...
  f6:	7ee58593          	addi	a1,a1,2030 # 8e0 <malloc+0x10a>
  fa:	4505                	li	a0,1
  fc:	00000097          	auipc	ra,0x0
 100:	5f4080e7          	jalr	1524(ra) # 6f0 <fprintf>
    close(p1[1]);
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48c:	4d050513          	addi	a0,a0,1232 # 958 <digits>
 490:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54c:	3b8c8c93          	addi	s9,s9,952 # 900 <malloc+0x12a>
 ...
 55a:	402b8b93          	addi	s7,s7,1026 # 958 <digits>
 ...
 680:	27c98993          	addi	s3,s3,636 # 8f8 <malloc+0x122>
        while(*s != 0){
 684:	85ee                	mv	a1,s11
